// Connect command prompt for Discord bot - same as topic association but for single tweets
const connectCommandPrompt = (topic1, tweets) => {
...
module.exports = { connectCommandPrompt };