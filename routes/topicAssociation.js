...
Your task:
🔹 Generate 5 different tweet-length replies for EACH tweet (each under 280 characters)
🔹 Each reply must make a connection between the tweet and the broad topic "${topic1}"
🔹 Mix the styles:
 - Some replies should stand alone like this:
  "Inflation's got us paying steakhouse prices for rabbit food. At this rate, lettuce gonna be a luxury item soon 🥬📈"
 - Others should explicitly mention the tweet using the handle or the tweet link, like:
  "At this rate, lettuce gonna be a luxury item soon 🥬📈 just like how it got @handle paying steakhouse prices for rabbit food. https://twitter.com/handle/status/1234567890"
